...
public class BitcoinChartService : ChartServiceBase
{
    public BitcoinChartService(IServiceProvider serviceProvider, PriceChartOptions options) :
        base(serviceProvider, options, serviceProvider.GetRequiredService<ILogger<BitcoinChartService>>())
    {
    }
